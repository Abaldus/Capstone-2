...
import dominosLogo from './assets/Dom.png';
import oreoLogo from './assets/Oreo.png';
import cokeLogo from './assets/Frito.png';
import jackLogo from './assets/Jack.png';
        ...
        <Box textAlign='center' className='heroBox'>
            ...
            <div>
                <Button className={clsx(classes.root, className)} {...other} variant="contained" href="https://www.youtube.com/watch?v=h2Jg8ryVk1k" >
                    <img className="cokeLogo" src={ cokeLogo } alt="cokeLogo" height="300%" width="300%"/>
                </Button>
                <Button className={clsx(classes.root, className)} {...other} variant="contained"  href="https://www.youtube.com/watch?v=fTgawFAEN0U" >
                    <img className="jackLogo" src={ jackLogo } alt="jackLogo" height="400%" width="400%"/>
                </Button>
                {/* 
